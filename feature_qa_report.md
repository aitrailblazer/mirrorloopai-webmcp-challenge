...
- F-032 `Cross-device reflection after confirmation` — High — Failed Test
...
- `qa_evidence/post_confirmation_cross_device/; feature_status_tracker.csv; feature_status_tracker.xlsx; feature_status_tracker.html; feature_qa_report.md`
