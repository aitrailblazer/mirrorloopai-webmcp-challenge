...
<StrategiXVisualSpec version="1.0" artifact="mirrorloop-webmcp-operational-use-cases" generatedAt="${evaluation.generatedAt}">
  <Purpose>Define six concrete operational examples that a judge or visitor can reproduce with the live eight-tool MIRROR//LOOP WebMCP contract.</Purpose>
  <ProductContract>
  ...
  <SourceDigest>
    <Source path="web/lib/webmcp.js">Production eight-tool contract.</Source>
  ...
  <ImplementationNotes>The public tool count remains eight; these scenarios add evaluation and explanation, not new runtime authority.</ImplementationNotes>
</StrategiXVisualSpec>
  </script>
        ...
        return html\`
          <main>
            <section class="hero">
              ...
              <p>Each scenario retains the real operational dilemma while using only public card metadata and the existing eight bounded tools. Symbolic material is presented as a reflection lens—not as diagnosis, astronomy, legal authority, or hidden evidence.</p>
              <div class="metrics">
            ...
            <section class="panel">
              ...
              <p>Gemini 2.5 Flash received the eight contracts discovered from the production page. All six cases matched the frozen tool sequence and arguments exactly.</p>
