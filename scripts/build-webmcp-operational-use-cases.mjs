...
<StrategiXVisualSpec version="1.0" artifact="mirrorloop-webmcp-operational-use-cases" generatedAt="${evaluation.generatedAt}">
  <Purpose>Define six concrete operational examples that a judge or visitor can reproduce with the live nine-tool MIRROR//LOOP WebMCP contract.</Purpose>
  <ProductContract>
  ...
  <SourceDigest>
    <Source path="web/lib/webmcp.js">Production nine-tool contract.</Source>
  ...
  <ImplementationNotes>The public tool count is nine; compare_choices adds read-only differentiation without new persistence, identity, commerce, or payment authority.</ImplementationNotes>
</StrategiXVisualSpec>
  </script>
        ...
        return html\`
          <main>
            <section class="hero">
              ...
              <p>Each scenario retains the real operational dilemma while using only public card metadata and the nine bounded tools. Symbolic material is presented as a reflection lens—not as diagnosis, astronomy, legal authority, or hidden evidence.</p>
              <div class="metrics">
            ...
            <section class="panel">
              ...
              <p>The preserved Gemini 2.5 Flash run received the prior eight contracts discovered from production. All six cases matched that frozen sequence and arguments exactly; compare_choices is covered by the current deterministic and browser suites pending a refreshed external-agent run.</p>
