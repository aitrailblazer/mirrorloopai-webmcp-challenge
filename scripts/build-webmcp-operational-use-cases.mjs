...
<StrategiXVisualSpec version="1.0" artifact="mirrorloop-webmcp-operational-use-cases" generatedAt="${evaluation.generatedAt}">
  ...
  <ImplementationNotes>The public tool count is eleven; compare_choices adds read-only differentiation, preview_answer_impact adds provisional score simulation, and export_reflection_dossier adds an explicitly confirmed local-only download without new persistence, identity, commerce, or payment authority.</ImplementationNotes>
</StrategiXVisualSpec>
  </script>
        ...
        return html\`
          <main>
            <section class="hero">
              ...
              <p>Each scenario retains the real operational dilemma while using only public card metadata and the eleven bounded tools. Symbolic material is presented as a reflection lens—not as diagnosis, astronomy, legal authority, or hidden evidence.</p>
              <div class="metrics">
