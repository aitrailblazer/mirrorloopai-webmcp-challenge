...
const claims = [
  ...
  ["Typed WebMCP actions reduce navigation burden", "SUPPORTED_WITH_QUALIFICATION", "Eleven typed tools replace brittle control inference for the bounded reflection and card flows; compare_choices neutrally distinguishes two options and preview_answer_impact simulates one changed answer without recording it."],
  ...
  ["Dyadic synthesis and P2P zero knowledge", "CONTRADICTED", "No multi-user exchange exists. This needs separate privacy, consent, threat-model, and product review."],
...
<StrategiXVisualSpec version="1.0" artifact="mirrorloop-webmcp-competition-hardening" generatedAt="2026-08-29">
  ...
  <ClaimLedger>
    ...
    <Claim id="typed_navigation" status="SUPPORTED_WITH_QUALIFICATION">Eleven typed tools support the bounded experience.</Claim>
    ...
    <Claim id="p2p" status="CONTRADICTED">No dyadic exchange or P2P workflow is deployed.</Claim>
  ...
  <DemoContract duration_verified="2:32.283" maximum="3:00" voice="Apple Ava Premium" scenes="16" caption_cues="36" audio_video_drift_ms="1" captions="open-yellow" caption_safe_area="180px-lower-band">
    <Beat order="1">Introduce AITrailblazer, the MIRROR//LOOP identity and logo, copyright, The WebMCP Challenge, and why safer human-agent cooperation matters.</Beat>
    <Beat order="2">Explain MIRROR//LOOP as a two-minute reflection that counters stress, generic advice, and pseudo-solutions by turning twelve everyday situations into a response pattern and practical next step.</Beat>
    <Beat order="3">Explain the website challenge: twelve questions and 144 cards create comprehension and navigation friction for people, while generic agents otherwise infer intent from controls.</Beat>
    <Beat order="4">Define WebMCP as the typed contract through which a live website publishes named capabilities with validated inputs and structured results, so an agent can invoke site-owned behavior instead of scraping or guessing.</Beat>
    <Beat order="5">Present the competition entry: one visual human interface and one bounded agent interface over the same browser state and rules; the agent clarifies and navigates, the browser scores, and the person confirms.</Beat>
    <Beat order="6">Start a reflection, read the current question, and compare two choices without selecting either.</Beat>
    <Beat order="7">Demonstrate failed unconfirmed recording, then explicit confirmation and visible step transition.</Beat>
    <Beat order="8">Complete deterministic local scoring from twelve human-confirmed answers.</Beat>
    <Beat order="9">Preview one hypothetical answer without mutation, then retrieve an exact public card.</Beat>
    <Beat order="10">Recommend a matching digital ARC edition and export a confirmed local dossier.</Beat>
    <Beat order="11">End on a dedicated MIRROR//LOOP human-control card with the live site, public source, and license.</Beat>
  </DemoContract>
  <DecisionLog>
        ...
        return html\`
          <main>
            <section>
              ...
              <p class="verdict"><strong>The strongest submission is the reproducible one—not the one that declares itself perfect.</strong> Show the real eleven-tool experience, including neutral two-choice contrast and provisional answer-impact preview, and exclude invented events, engines, products, and payment authority.</p>
              <div class="metrics">
                <div class="metric"><strong>11 tools</strong>production contract</div>
            ...
            <section>
              <h2>Final verified 2:32 demo</h2>
              <div class="beats">
                <div class="beat"><strong>0:00–0:13</strong><p>Identify AITrailblazer and MIRROR//LOOP, show the logo and copyright, and explain the WebMCP Challenge's importance.</p></div>
                <div class="beat"><strong>0:13–0:40</strong><p>Explain MIRROR//LOOP's value amid stress and pseudo-solutions, then define the website's comprehension and navigation challenge.</p></div>
                <div class="beat"><strong>0:40–1:03</strong><p>Define WebMCP and present the entry's shared human/agent experience with explicit authority boundaries.</p></div>
                <div class="beat"><strong>1:03–1:29</strong><p>Show live registration, start the reflection, read the current question, and compare two choices without selecting either.</p></div>
                <div class="beat"><strong>1:29–1:50</strong><p>Reject an unconfirmed answer, confirm the human choice, and complete deterministic local scoring.</p></div>
                <div class="beat"><strong>1:50–2:20</strong><p>Preview without mutation, retrieve a card, recommend a digital edition, and export a local dossier.</p></div>
                <div class="beat"><strong>2:20–2:32</strong><p>End on the human authority boundary, live site, public source, and MIT license.</p></div>
              </div>
              <p>Apple <strong>Ava (Premium)</strong> narration, 36 SRT cues, the plain-language explanation rail, and gold focus highlighting share one 16-scene timeline. Yellow open captions remain in a dedicated 180-pixel lower band. The packaged candidate measures 1 millisecond of audio/video drift.</p>
            </section>
            <section>
...
The submitted evidence includes a 15-case baseline, a 10-case campaign boundary suite, and six operational scenarios executed through the production-discovered WebMCP contracts. Judges can reproduce the core path in Chrome DevTools: start, read, explain, reject an unconfirmed answer, confirm it, complete all twelve answers, retrieve Card 004, and request a digital-edition recommendation.</div>
            ...
            <section>
              ...
              <p><strong>Freeze the reviewed eleven-tool build.</strong> Do not add P2P exchange, an astronomical engine, physical fulfillment, or x402 before submission. Those features change privacy, consent, data-flow, product, or payment boundaries and require separate design and testing.</p>
