...
const checks = [
  ...
  ["README autonomous-agent rationale", [
    "## Why Autonomous Agents Co-Pilot This Node",
    "Deterministic state and scoring",
    "Selective context instead of corpus loading",
    "Authoritative public meanings",
    "A bounded deliverable",
    "Human authority is enforced by the tool boundary",
    "Private by default, with explicit exceptions",
  ...
  ["Evidence-bounded demo recording contract", [
    ...
    "Chat-only burden",
    "Site-owned WebMCP contract",
    "architectural contrast",
    "explain_choice,compare_choices",
